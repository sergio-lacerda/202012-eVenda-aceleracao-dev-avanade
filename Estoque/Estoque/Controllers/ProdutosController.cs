...
namespace Estoque.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,codProd,nomeProd,precoProd,qtdEstProd")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,codProd,nomeProd,precoProd,qtdEstProd")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
